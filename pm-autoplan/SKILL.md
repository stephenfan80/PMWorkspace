...
5. Read `../pmworkspace-shared/references/pm-decision-principles.md`.
6. Read `../pmworkspace-shared/references/pm-eval-system.md` and treat its contracts as maintenance guardrails for PMWorkspace behavior.
7. Read `../pmworkspace-shared/references/routing.md`; if `$pm-autoplan` was entered from `$pm-workspace`, inherit its mode and run. If called directly, use routing D0 to choose mode.
8. Read `../pmworkspace-shared/references/question-tuning.md`.
9. Read `../pmworkspace-shared/references/product-office-hours.md`.
10. Read `../pmworkspace-shared/references/adversarial-review.md`.
